...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        <dl class="row mb-0">
            ...
            <dd class="col-sm-9"><code><?= h($educationLevel->code) ?></code></dd>
    ...
    <div class="card-footer">
        <?= $this->Html->link('<i class="bi bi-pencil me-1"></i>Editar', ['action' => 'edit', $educationLevel->id], ['class' => 'btn btn-warning btn-sm', 'escape' => false]) ?>
        <?= $this->Form->postLink('<i class="bi bi-trash me-1"></i>Eliminar', ['action' => 'delete', $educationLevel->id], ['confirm' => '¿Está seguro?', 'class' => 'btn btn-danger btn-sm', 'escape' => false]) ?>
    </div>
</div>
