...
<div class="sgi-page-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex gap-2">
        ...
        <?php if (!empty($userPermissions['organizaciones_temporales']['can_create'])): ?>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <?php if (!empty($userPermissions['organizaciones_temporales']['can_edit'])): ?>
                        <?= $this->Html->link('<i class="bi bi-pencil"></i>', ['action' => 'edit', $org->id], ['class' => 'btn btn-sm btn-outline-warning', 'escape' => false, 'title' => 'Editar']) ?>
                        <?php endif; ?>
                        <?php if (!empty($userPermissions['organizaciones_temporales']['can_delete'])): ?>
